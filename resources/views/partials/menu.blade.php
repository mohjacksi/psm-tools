<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('general_tab_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/projects*") ? "c-show" : "" }} {{ request()->is("admin/samples*") ? "c-show" : "" }} {{ request()->is("admin/channels*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
        ...
        @can('experiment_tab_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/experiments*") ? "c-show" : "" }} {{ request()->is("admin/biological-sets*") ? "c-show" : "" }} {{ request()->is("admin/fractions*") ? "c-show" : "" }} {{ request()->is("admin/stripes*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-flask c-sidebar-nav-icon">
        ...
        @endcan
        @can('option_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/fragment-methods*") ? "c-show" : "" }} {{ request()->is("admin/tissues*") ? "c-show" : "" }} {{ request()->is("admin/sample-conditions*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('sample_condition_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.sample-conditions.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/sample-conditions") || request()->is("admin/sample-conditions/*") ? "c-active" : "" }}">
        ...
        @can('peptide_protein_tab_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/peptides*") ? "c-show" : "" }} {{ request()->is("admin/proteins*") ? "c-show" : "" }} {{ request()->is("admin/peptide-with-modifications*") ? "c-show" : "" }} {{ request()->is("admin/peptid-categories*") ? "c-show" : "" }} {{ request()->is("admin/protein-types*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('peptide_with_modification_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.peptide-with-modifications.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/peptide-with-modifications") || request()->is("admin/peptide-with-modifications/*") ? "c-active" : "" }}">
                    ...
                    @can('peptid_category_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.peptid-categories.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/peptid-categories") || request()->is("admin/peptid-categories/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                    ...
                    @can('protein_type_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.protein-types.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/protein-types") || request()->is("admin/protein-types/*") ? "c-active" : "" }}">
        ...
        @can('species_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.speciess.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/speciess") || request()->is("admin/speciess/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
