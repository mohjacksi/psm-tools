    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-stripd table-hover datatable datatable-projectPeople">
                    <thead>
                        <tr>
                            <th width="10">
                                ...
                                <td>
                                    @can('person_show')
                                        <a class="btn btn-xs btn-primary"
                                            href="{{ route('admin.people.show', $person->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-projectPeople:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
