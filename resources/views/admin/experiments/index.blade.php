...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-stripd table-hover ajaxTable datatable datatable-Experiment">
                <thead>
                    <tr>
                        <th width="10">
        ...
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                columns: [{
                    ...
                    {
                        data: 'allowed_missed_cleavage',
                        name: 'allowed_missed_cleavage'
                    },
                    {
                        data: 'expression_threshold',
                    ...
                    {
                        data: 'reference_protein_source',
                        name: 'reference_protein_source'
                    },
                    {
                        data: 'other_protein_source',
                        name: 'other_protein_source'
                    },
                    {
                        data: 'psm_file_name',
                        name: 'psm_file_name'
