...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Experiment">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.experiments.index') }}",
    columns: [
...
{ data: 'allowed_missed_cleavage', name: 'allowed_missed_cleavage' },
{ data: 'expression_threshold', name: 'expression_threshold' },
{ data: 'species_name', name: 'species.name' },
{ data: 'reference_protein_source', name: 'reference_protein_source' },
{ data: 'other_protein_source', name: 'other_protein_source' },
{ data: 'psm_file_name', name: 'psm_file_name' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Experiment').DataTable(dtOverrideGlobals);
