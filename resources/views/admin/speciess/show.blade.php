    ...
    <div class="card">
        ...
        <div class="tab-content">
            <div class="tab-pane" role="tabpanel" id="species_samples">
                @includeIf('admin.speciess.relationships.speciesSamples', [
                    'samples' => $species->speciesSamples,
                ])
            </div>
            <div class="tab-pane" role="tabpanel" id="species_experiments">
                @includeIf('admin.speciess.relationships.speciesExperiments', [
                    'experiments' => $species->speciesExperiments,
                ])
            </div>
        </div>
    </div>
