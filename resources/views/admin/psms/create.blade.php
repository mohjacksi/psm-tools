...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.psm.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.psms.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="spectra">{{ trans('cruds.psm.fields.spectra') }}</label>
                <input class="form-control {{ $errors->has('spectra') ? 'is-invalid' : '' }}" type="text" name="spectra" id="spectra" value="{{ old('spectra', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('fraction') ? 'is-invalid' : '' }}" name="fraction_id" id="fraction_id" required>
                    @foreach($fractions as $id => $entry)
                        <option value="{{ $id }}" {{ old('fraction_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('scan_num') ? 'is-invalid' : '' }}" type="number" name="scan_num" id="scan_num" value="{{ old('scan_num', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('precursor') ? 'is-invalid' : '' }}" type="number" name="precursor" id="precursor" value="{{ old('precursor', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('isotope_error') ? 'is-invalid' : '' }}" type="number" name="isotope_error" id="isotope_error" value="{{ old('isotope_error', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('precursor_error') ? 'is-invalid' : '' }}" type="number" name="precursor_error" id="precursor_error" value="{{ old('precursor_error', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('charge') ? 'is-invalid' : '' }}" type="number" name="charge" id="charge" value="{{ old('charge', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('de_novo_score') ? 'is-invalid' : '' }}" type="text" name="de_novo_score" id="de_novo_score" value="{{ old('de_novo_score', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('msgf_score') ? 'is-invalid' : '' }}" type="number" name="msgf_score" id="msgf_score" value="{{ old('msgf_score', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('space_evalue') ? 'is-invalid' : '' }}" type="number" name="space_evalue" id="space_evalue" value="{{ old('space_evalue', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('evalue') ? 'is-invalid' : '' }}" type="text" name="evalue" id="evalue" value="{{ old('evalue', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('precursor_svm_score') ? 'is-invalid' : '' }}" type="text" name="precursor_svm_score" id="precursor_svm_score" value="{{ old('precursor_svm_score', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('psm_q_value') ? 'is-invalid' : '' }}" type="number" name="psm_q_value" id="psm_q_value" value="{{ old('psm_q_value', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('peptide_q_value') ? 'is-invalid' : '' }}" type="number" name="peptide_q_value" id="peptide_q_value" value="{{ old('peptide_q_value', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('missed_clevage') ? 'is-invalid' : '' }}" type="number" name="missed_clevage" id="missed_clevage" value="{{ old('missed_clevage', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('experimental_pl') ? 'is-invalid' : '' }}" type="number" name="experimental_pl" id="experimental_pl" value="{{ old('experimental_pl', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('predicted_pl') ? 'is-invalid' : '' }}" type="number" name="predicted_pl" id="predicted_pl" value="{{ old('predicted_pl', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delta_pl') ? 'is-invalid' : '' }}" type="number" name="delta_pl" id="delta_pl" value="{{ old('delta_pl', '') }}" step="0.00001">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('peptide_with_modification') ? 'is-invalid' : '' }}" name="peptide_with_modification_id" id="peptide_with_modification_id">
                    @foreach($peptide_with_modifications as $id => $entry)
                        <option value="{{ $id }}" {{ old('peptide_with_modification_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
