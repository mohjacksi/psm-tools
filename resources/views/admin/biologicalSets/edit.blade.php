    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.biological-sets.update", [$biologicalSet->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('labeling_number') ? 'is-invalid' : '' }}" type="number" name="labeling_number" id="labeling_number" value="{{ old('labeling_number', $biologicalSet->labeling_number) }}" step="1">
