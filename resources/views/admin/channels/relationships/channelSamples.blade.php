...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-stripd table-hover datatable datatable-channelSamples">
                <thead>
                    <tr>
                        <th width="10">
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-channelSamples:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
