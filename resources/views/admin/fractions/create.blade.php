...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.fractions.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spectra_file_name') ? 'is-invalid' : '' }}" type="text" name="spectra_file_name" id="spectra_file_name" value="{{ old('spectra_file_name', '') }}">
