...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-stripd table-hover ajaxTable datatable datatable-Sample">
                <thead>
                    <tr>
                        <th width="10">
        ...
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                columns: [{
                    ...
                    {
                        data: 'sample_condition_name',
                        name: 'sample_condition.name'
                    },
                    {
                        data: 'actions',
