...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table
                class=" table table-bordered table-stripd table-hover datatable datatable-peptideWithModificationPsms">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    @foreach ($psms as $key => $psm)
                        <tr data-entry-id="{{ $psm->id }}">
                            ...
                            <td>
                                ...
                                @can('psm_delete')
                                    <form action="{{ route('admin.psms.destroy', $psm->id) }}" method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-peptideWithModificationPsms:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
