                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('channel_psm_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.channel-psms.index') }}">
                                            {{ trans('cruds.channelPsm.title') }}
                                        </a>
                                    @endcan
                                    @can('peptide_psm_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.peptide-psms.index') }}">
                                    ...
                                    @can('experiment_biological_set_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.experiment-biological-sets.index') }}">
                                    ...
                                    @can('fragment_method_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.fragment-methods.index') }}">
                                    ...
                                    @can('peptide_protein_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.peptide-proteins.index') }}">
