    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.transcripts.update", [$transcript->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="transcript">{{ trans('cruds.transcript.fields.transcript') }}</label>
                            <input class="form-control" type="text" name="transcript" id="transcript" value="{{ old('transcript', $transcript->transcript) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $transcript->name) }}">
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="transcript_sequence" id="transcript_sequence" value="{{ old('transcript_sequence', $transcript->transcript_sequence) }}">
