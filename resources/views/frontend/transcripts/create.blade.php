    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.transcripts.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="transcript">{{ trans('cruds.transcript.fields.transcript') }}</label>
                            <input class="form-control" type="text" name="transcript" id="transcript" value="{{ old('transcript', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="transcript_sequence" id="transcript_sequence" value="{{ old('transcript_sequence', '') }}">
