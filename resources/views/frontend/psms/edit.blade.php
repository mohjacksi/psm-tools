    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.psms.update", [$psm->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="spectra">{{ trans('cruds.psm.fields.spectra') }}</label>
                            <input class="form-control" type="text" name="spectra" id="spectra" value="{{ old('spectra', $psm->spectra) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="fraction_id" id="fraction_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="peptide_modification" id="peptide_modification">{!! old('peptide_modification', $psm->peptide_modification) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="scan_num" id="scan_num" value="{{ old('scan_num', $psm->scan_num) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="precursor" id="precursor" value="{{ old('precursor', $psm->precursor) }}" step="0.00001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="isotope_error" id="isotope_error" value="{{ old('isotope_error', $psm->isotope_error) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="precursor_error" id="precursor_error" value="{{ old('precursor_error', $psm->precursor_error) }}" step="0.00001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="charge" id="charge" value="{{ old('charge', $psm->charge) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="de_novo_score" id="de_novo_score" value="{{ old('de_novo_score', $psm->de_novo_score) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="msgf_score" id="msgf_score" value="{{ old('msgf_score', $psm->msgf_score) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="space_evalue" id="space_evalue" value="{{ old('space_evalue', $psm->space_evalue) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="evalue" id="evalue" value="{{ old('evalue', $psm->evalue) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="precursor_svm_score" id="precursor_svm_score" value="{{ old('precursor_svm_score', $psm->precursor_svm_score) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="psm_q_value" id="psm_q_value" value="{{ old('psm_q_value', $psm->psm_q_value) }}" step="0.00001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="peptide_q_value" id="peptide_q_value" value="{{ old('peptide_q_value', $psm->peptide_q_value) }}" step="0.00001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="missed_clevage" id="missed_clevage" value="{{ old('missed_clevage', $psm->missed_clevage) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="experimental_pl" id="experimental_pl" value="{{ old('experimental_pl', $psm->experimental_pl) }}" step="0.00001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="predicted_pl" id="predicted_pl" value="{{ old('predicted_pl', $psm->predicted_pl) }}" step="0.00001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="delta_pl" id="delta_pl" value="{{ old('delta_pl', $psm->delta_pl) }}" step="0.00001">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="peptide_with_modification_id" id="peptide_with_modification_id">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.psms.storeCKEditorImages') }}', true);
