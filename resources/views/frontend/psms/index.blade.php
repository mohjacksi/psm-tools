                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class=" table table-bordered table-stripd table-hover datatable datatable-Psm">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('psm_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.psms.show', $psm->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('psm_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.psms.edit', $psm->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('psm_delete')
                                                    <form action="{{ route('frontend.psms.destroy', $psm->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Psm:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
