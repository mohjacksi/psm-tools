                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class=" table table-bordered table-stripd table-hover datatable datatable-Project">
                                <thead>
                                    <tr>
                                        <th>
                                ...
                                <tbody>
                                    @foreach ($projects as $key => $project)
                                        <tr data-entry-id="{{ $project->id }}">
                                            ...
                                            <td>
                                                <span style="display:none">{{ $project->public ?? '' }}</span>
                                            ...
                                            <td>
                                                @can('project_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.projects.show', $project->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('project_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.projects.edit', $project->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
