    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.experiments.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="allowed_missed_cleavage" id="allowed_missed_cleavage" value="1" {{ old('allowed_missed_cleavage', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="expression_threshold" id="expression_threshold" value="{{ old('expression_threshold', '') }}" step="0.0001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="reference_protein_source" id="reference_protein_source" value="{{ old('reference_protein_source', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="other_protein_source" id="other_protein_source" value="{{ old('other_protein_source', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="psm_file_name" id="psm_file_name" value="{{ old('psm_file_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="metadata" id="metadata">{!! old('metadata') !!}</textarea>
