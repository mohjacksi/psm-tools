    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.experiments.update", [$experiment->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="name">{{ trans('cruds.experiment.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $experiment->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date" id="date" value="{{ old('date', $experiment->date) }}">
                            @if($errors->has('date'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('date') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="allowed_missed_cleavage" id="allowed_missed_cleavage" value="1" {{ $experiment->allowed_missed_cleavage || old('allowed_missed_cleavage', 0) === 1 ? 'checked' : '' }}>
                                <label for="allowed_missed_cleavage">{{ trans('cruds.experiment.fields.allowed_missed_cleavage') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="expression_threshold" id="expression_threshold" value="{{ old('expression_threshold', $experiment->expression_threshold) }}" step="0.0001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="reference_protein_source" id="reference_protein_source" value="{{ old('reference_protein_source', $experiment->reference_protein_source) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="other_protein_source" id="other_protein_source" value="{{ old('other_protein_source', $experiment->other_protein_source) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="psm_file_name" id="psm_file_name" value="{{ old('psm_file_name', $experiment->psm_file_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="metadata" id="metadata">{!! old('metadata', $experiment->metadata) !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.experiments.storeCKEditorImages') }}', true);
