                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.samples.update", [$sample->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $sample->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="details" id="details">{!! old('details', $sample->details) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="replicate_number" id="replicate_number" value="{{ old('replicate_number', $sample->replicate_number) }}" step="1">
