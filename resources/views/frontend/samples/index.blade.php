            ...
            @can('sample_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        ...
                        @include('csvImport.modal', ['model' => 'Sample', 'route' => 'admin.samples.parseCsvImport'])
                    </div>
                </div>
            @endcan
            <div class="card">
                            ...
                            <tbody>
                                @foreach($samples as $key => $sample)
                                    <tr data-entry-id="{{ $sample->id }}">
                                        ...
                                        <td>
                                            @can('sample_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.samples.show', $sample->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('sample_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.samples.edit', $sample->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('sample_delete')
                                                <form action="{{ route('frontend.samples.destroy', $sample->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
