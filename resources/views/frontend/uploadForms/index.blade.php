                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class=" table table-bordered table-stripd table-hover datatable datatable-UploadForm">
                                <thead>
                                    <tr>
                                        <th>
                                            ...
                                            <td>
                                                @can('upload_form_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('frontend.upload-forms.show', $uploadForm->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('upload_form_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('frontend.upload-forms.edit', $uploadForm->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('upload_form_delete')
                                                    <form
                                                        action="{{ route('frontend.upload-forms.destroy', $uploadForm->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-UploadForm:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
