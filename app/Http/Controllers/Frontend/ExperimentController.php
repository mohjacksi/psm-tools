...
class ExperimentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.experiments.index', compact('experiments', 'projects'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.experiments.create', compact('projects'));
    }
    ...
    public function edit(Experiment $experiment)
    {
        ...
        return view('frontend.experiments.edit', compact('experiment', 'projects'));
    }
