...
class SampleController extends Controller
{
    ...
    public function index()
    {
        ...
        $samples = Sample::with(['person', 'project', 'channel', 'tissue'])->get();
        ...
        return view('frontend.samples.index', compact('channels', 'people', 'projects', 'samples', 'tissues'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.samples.create', compact('channels', 'people', 'projects', 'tissues'));
    }
    ...
    public function edit(Sample $sample)
    {
        ...
        return view('frontend.samples.edit', compact('channels', 'people', 'projects', 'sample', 'tissues'));
    }
