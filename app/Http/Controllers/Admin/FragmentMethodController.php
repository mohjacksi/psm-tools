...
class FragmentMethodController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = FragmentMethod::query()->select(sprintf('%s.*', (new FragmentMethod())->table));
        ...
        return view('admin.fragmentMethods.index');
    }
    ...
    public function show(FragmentMethod $fragmentMethod)
    {
        ...
        $fragmentMethod->load('fragmentMethodBiologicalSets');
