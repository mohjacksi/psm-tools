...
class ExperimentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Experiment::with(['project'])->select(sprintf('%s.*', (new Experiment())->table));
            ...
            $table->editColumn('species', function ($row) {
            ...
            $table->rawColumns(['actions', 'placeholder', 'project', 'allowed_missed_cleavage']);
        ...
        return view('admin.experiments.index', compact('projects'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.experiments.create', compact('projects'));
    }
    ...
    public function edit(Experiment $experiment)
    {
        ...
        return view('admin.experiments.edit', compact('experiment', 'projects'));
    }
