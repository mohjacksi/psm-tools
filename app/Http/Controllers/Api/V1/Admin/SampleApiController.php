...
class SampleApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new SampleResource(Sample::with(['project', 'channels', 'species', 'tissue', 'sample_condition', 'created_by'])->get());
    }
    ...
    public function show(Sample $sample)
    {
        ...
        return new SampleResource($sample->load(['project', 'channels', 'species', 'tissue', 'sample_condition', 'created_by']));
    }
