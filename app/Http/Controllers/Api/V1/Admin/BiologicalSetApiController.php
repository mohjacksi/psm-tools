...
class BiologicalSetApiController extends Controller
{
    public function index()
    {
        ...
        return new BiologicalSetResource(BiologicalSet::with(['experiment_biological_set', 'stripe', 'fragment_method'])->get());
    }
    ...
    public function show(BiologicalSet $biologicalSet)
    {
        ...
        return new BiologicalSetResource($biologicalSet->load(['experiment_biological_set', 'stripe', 'fragment_method']));
    }
