...
class PsmApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new PsmResource(Psm::with(['fraction', 'peptide_with_modification', 'created_by'])->get());
    }
    ...
    public function show(Psm $psm)
    {
        ...
        return new PsmResource($psm->load(['fraction', 'peptide_with_modification', 'created_by']));
    }
